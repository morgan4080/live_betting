defmodule LiveBettingWeb.UserAuth do
  ...
  alias LiveBetting.Contexts.Accounts
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      LiveBettingWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule LiveBettingWeb.PageLive do
        use LiveBettingWeb, :live_view

        on_mount {LiveBettingWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{LiveBettingWeb.UserAuth, :ensure_authenticated}] do
  ...
  def require_authenticated_user_admin(conn, _opts) do
    if conn.assigns[:current_user] do
      if user_type = conn.assigns[:current_user].user_type.type_name do
