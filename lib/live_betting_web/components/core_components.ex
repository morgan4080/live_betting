defmodule LiveBettingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveBettingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveBettingWeb.Gettext, "errors", msg, opts)
    end
  end
