defmodule LiveBetting.Schema.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, LiveBetting.Repo)
  ...
  defp maybe_validate_unique_msisdn(changeset, opts) do
    if Keyword.get(opts, :validate_msisdn, true) do
      changeset
      |> unsafe_validate_unique(:msisdn, LiveBetting.Repo)
  ...
  """
  def valid_password?(%LiveBetting.Schema.User{hashed_password: hashed_password}, password)
